...
public class GroupController {
    ...
    public ResponseEntity<?> createGroup(@RequestBody DtoAdminGroup adminGroups){
    ...
    public ResponseEntity<?> updateGroup(@RequestBody DtoAdminGroup group) throws ResourceNotFoundException {
