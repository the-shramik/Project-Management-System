...
public class ProductivityServiceImpl implements IProductivityService {
    ...
    @Override
    public Productivity addProductivity(DtoProductivity productivity) {

        Productivity p=new Productivity();
        p.setStartDate(productivity.getStartDate());
        p.setEndDate(productivity.getEndDate());
        p.setProductivityName(productivity.getProductivityName());
        p.setStatus(productivity.getStatus());
        p.setProject(productivity.getProject());
        p.setDescription(productivity.getDescription());
        return productivityRepository.save(p);
    }
    ...
    @Override
    public Productivity updateProductivity(DtoProductivity productivity) throws ResourceNotFoundException {
